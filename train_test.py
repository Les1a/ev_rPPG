        ...
        with h5py.File(file_path, 'r') as file:
            ...
            for i in range(12):
                ...
                for idx in range(start, end):
                    ...
                    input_voxel = events_to_voxel(xs, ys, ts, ps, 3).unsqueeze(0).to(device)
                    if idx == start:
                ...
                input_cat = input_cat.view(3, 160, 128, 128)
                rPPG, Score1, Score2, Score3 = model_rppg(input_cat.unsqueeze(0), gra_sharp=2.0)
            ...
            if (epoch + 1) % 10 == 0 or (epoch + 1) == len(os.listdir(data_path)):
                ...
                # torch.save(model_e2vid.state_dict(), 'run/' + args.log + '/e2vid' + '_%d.pkl' % epoch)
